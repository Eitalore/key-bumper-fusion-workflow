// BYD DOLPHIN — BUMPER TPU COM SLOT LATERAL PARA LÂMINA CANIVETE
// V0.2 PARAMÉTRICA
// Protege traseira e laterais; face dos quatro controles aberta.
// O manual oficial identifica lock, unlock, boot, Start/Stop, indicador e chave mecânica.
...
// ===================== MEDIDAS DA CHAVE =====================
KEY_L = 78.0;       // comprimento do corpo, eixo X, mm
KEY_W = 34.0;       // largura máxima, eixo Y, mm
KEY_T = 14.5;       // espessura máxima, eixo Z, mm
KEY_R = 7.0;        // raio aproximado dos cantos em planta, mm
...
BLADE_SLOT_W = 20.0;       // largura/comprimento em X
BLADE_SLOT_Z = 6.5;        // centro da janela em Z a partir da base
BLADE_SLOT_H = 7.0;        // altura da janela em Z
BLADE_SLOT_R = 1.5;        // raio dos cantos

// Se a lâmina deve abrir com a capa instalada, comece com
...
// ===================== AJUSTE RÁPIDO =====================
// BLADE_SLOT_X = posição da janela ao longo da chave.
// BLADE_SLOT_W = largura/comprimento da janela no eixo X.
// BLADE_SLOT_Z = altura da janela no eixo Z.
// BLADE_SLOT_H = altura da janela no eixo Z.
// BLADE_SLOT_SIDE = lado da chave: +1 ou -1.
// BLADE_SLOT_R >= 1.5 mm reduz o risco de rasgo no TPU.
// Imprima primeiro um trecho de teste de 10–15 mm.
